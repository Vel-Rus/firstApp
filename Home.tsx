...
const Home = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.titleText}>BMI Calculator3</Text>
      ...
      <TouchableOpacity
        style={[
          styles.goButton, 
          parseInt(height) && parseInt(weight) && {opacity: 1}
        ]}
        
        disabled={((parseInt(height) > 0 ) && (parseInt(weight) > 0)) ? false : true }
      ...
      <View style={styles.ColorContainer}>
        ...
        >
          <Image
            ...
            contentFit="fill"
          />
          <Text style={styles.valueText}>More 18</Text>
        ...
        <View style={[styles.RedBlock, BMI >= 25 && { opacity: 1 }]}>
          <Image
            ...
            contentFit="fill"
          />
          <Text style={styles.valueText}>More 25</Text>
